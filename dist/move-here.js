...
var IdGenerator = function () {
   function IdGenerator() {
      babelHelpers.classCallCheck(this, IdGenerator);
   }

   babelHelpers.createClass(IdGenerator, null, [{
      key: "getId",
...
var MotionAsset = function () {
   function MotionAsset(target, initTime, duration, unitsPerSecond, rotationPerSecond, motionDirection, rotateToDirection, simulateDepth, spawnLocation) {
      babelHelpers.classCallCheck(this, MotionAsset);
   ...
   babelHelpers.createClass(MotionAsset, [{
      key: 'id',
      get: function get() {
         return this._id;
      }
...
var Mathy = function () {
   function Mathy() {
      babelHelpers.classCallCheck(this, Mathy);
   }

   babelHelpers.createClass(Mathy, null, [{
      key: "radians",
...
var RandomMotionAdapter = function () {
   function RandomMotionAdapter(boundingRectangle) {
      babelHelpers.classCallCheck(this, RandomMotionAdapter);

      this._boundingRectangle = boundingRectangle;
      this._motionAssets = {};
   }

   babelHelpers.createClass(RandomMotionAdapter, [{
      key: 'addAsset',
...
var MotionEngine = function () {
   function MotionEngine() {
      ...
      babelHelpers.classCallCheck(this, MotionEngine);
   ...
   babelHelpers.createClass(MotionEngine, [{
      key: 'start',
      ...
      value: function addAsset() {
         ...
         var motionDirection = _ref$motionDirection === undefined ? MotionDirection.CURVE_RANDOM : _ref$motionDirection;
         ...
         var _ref$rotationSpeedMod = _ref.rotationSpeedModifier;
         var rotationSpeedModifier = _ref$rotationSpeedMod === undefined ? MIN_ROTATION_SPEED_MODIFIER : _ref$rotationSpeedMod;
         var _ref$rotateToDirectio = _ref.rotateToDirection;
         var rotateToDirection = _ref$rotateToDirectio === undefined ? true : _ref$rotateToDirectio;
